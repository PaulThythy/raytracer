...
void VulkanContext::createGraphicsPipeline() {
    auto vertShaderCode = Config::readFile("../shaders/vert.spv");
    auto fragShaderCode = Config::readFile("../shaders/frag.spv");
...
void VulkanContext::framePresent(ImGui_ImplVulkanH_Window* wd)
{
    ...
    VkResult err = vkQueuePresentKHR(m_presentQueue, &info);
    if (err == VK_ERROR_OUT_OF_DATE_KHR || err == VK_SUBOPTIMAL_KHR)
    {
        m_swapChainRebuild = true;
        return;
