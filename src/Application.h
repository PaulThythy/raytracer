...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(Config::INIT_WINDOW_WIDTH, Config::INIT_WINDOW_HEIGHT, "Vulkan", nullptr, nullptr);
    ...
    // Copy data to buffer
    void copyDataToBuffer(const void* data, VkDeviceSize size, VkBuffer &buffer, VkDeviceMemory &bufferMemory) {
        void* mapped;
